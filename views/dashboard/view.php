...
<p>
    Η διεύθυνσή μας έχει αλλάξει. Παρακαλώ ανανεώστε τους σελειδοδείκτες σας.
</p>
<p>
    Κατά τη μεταφορά ενδέχεται να έχουν γίνει κάποια λάθη. 
    Σε περίπτωση που διαφωνείτε με την κατάσταση κάποιας από τις εργασίες 
    ενημερώστε μας για να το κοιτάξουμε. 
</p>
<div class="current">
    <h2><?php
